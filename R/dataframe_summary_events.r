...
#' segments
#' 
#' dataframe_summary_events creates one table with the following columns:
...
#' @return 
#' \describe{
#'     \item{event:}{String, event type either pausing site, iTSS_I, iTSS_II,
#'     Termination, HL_event, Int_event, HL_Int_event and velocity_change}
...
#'     events include HL fragment and intensity fragment}
#'     \item{segment_2:}{String, same description as segment_1 but is the second
