...
``` {r output_penalties}
#The output
data(e_coli_penalties)
head(rowRanges(e_coli_penalties))
```
<br/><br/>
...
<br/><br/>
``` {r echo = TRUE}
data(e_coli_fragmentation)
head(rowRanges(e_coli_fragmentation))
```
<br/><br/>
...
head(metadata(summary_minimal)[7])
```
<br/><br/>
...
stats_minimal
data(annot_g_minimal)
event_dataframe(data = stats_minimal, data_annotation = annot_g[[1]])
```
<br/>
