...
``` {r rifi_stats}
fragmentation_minimal
stats_minimal <- rifi_stats(inp = fragmentation_minimal, dista = 300, path =  "../inst/e_coli.gff3")
```
<br/>
...
``` {r gff3_preprocess, eval = FALSE}
  metadata(stats_minimal)$annot <- gff3_preprocess(path = "e_coli.gff3")
```
<br/>
